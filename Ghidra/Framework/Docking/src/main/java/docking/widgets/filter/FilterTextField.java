...
public class FilterTextField extends JPanel {
	...
	private static Color FILTERED_BACKGROUND_COLOR = UIManager.getColor("TextField.selectionBackground");
	/*package*/ static Color UNEDITABLE_BACKGROUND_COLOR = UIManager.getColor("TextField.inactiveBackground");
