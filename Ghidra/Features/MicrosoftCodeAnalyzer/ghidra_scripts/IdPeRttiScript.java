 ...
 */
// Script to identify Visual Studio and Clang PEs with RTTI
//@category C++
	...
	public void run() throws Exception {
		...
		if (!isPe) {
			if (!isRunningHeadless()) {
				...
				println("Executable path: " + currentProgram.getExecutablePath());
				println("Compiler type: " + currentProgram.getCompiler());
				return;
			}
			currentProgram.setTemporary(true);
			return;
